...
2. For event data questions (like "How many purchases last month?"):
   - Write and validate the SQL query
   - Check query against schema and print the query to the assistant
   - Estimate result size and print the result size to the assistant
   - Execute using query_bigquery tool and the run_async method
