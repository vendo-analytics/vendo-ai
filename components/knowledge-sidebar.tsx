...
const fetchFirebaseContent = async (userId: string = "001") => {
  try {
...
const addFirebaseContent = async (userId: string, content: string, messageType: string = "requirements") => {
  try {
...
const updateFirebaseContent = async (userId: string, index: number, newContent: string, messageType: string = "requirements") => {
  try {
...
const deleteFirebaseContent = async (userId: string, index: number, messageType: string = "requirements") => {
  try {
